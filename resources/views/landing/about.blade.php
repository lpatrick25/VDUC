        ...
        <div class="row" style="display: flex; align-items: center; flex-wrap: wrap;">
            <div class="col-md-6">
                ...
                <p class="about_text" style="text-indent: 20px;">
                    ...
                    engineering diving services, underwater survey/inspection, and maintenance. The company is based on the
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 benefits_2_single wow fadeInUp" data-wow-delay=".1s">
                ...
                <p>We use top-grade equipment and trained divers to ensure every project meets the highest industry standards.</p>
            </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 benefits_2_single wow fadeInUp" data-wow-delay=".3s">
                ...
                <p>From underwater surveys to diving lessons, we provide complete marine services under one trusted name.</p>
            </div>
            ...
            <div class="col-md-4 col-sm-6 col-xs-12 benefits_2_single wow fadeInUp" data-wow-delay=".4s">
                ...
                <p>We combine experience and modern techniques to deliver smart and effective underwater engineering solutions.</p>
            </div>
        ...
        <div class="row">
            <div class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp">
                <div class="team_member">
                    <img src="assets/img/vessel.avif" alt="team image">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-delay=".1s">
                <div class="team_member">
                    <img src="assets/img/vessel2.avif" alt="team image">
                    <div class="team_member_hover">
                        <div class="team_member_info">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 wow fadeInUp" data-wow-delay=".2s">
                <div class="team_member">
                    <img src="assets/img/vessel3.avif" alt="team image">
                    <div class="team_member_hover">
                        <div class="team_member_info">
